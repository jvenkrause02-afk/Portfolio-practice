...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 z-1000 w-full backdrop-blur-sm ${
          stickyMenu
            ? 'before:features-row-border py-4! shadow-sm backdrop-blur-md transition duration-100 before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full lg:py-0!'
            : 'py-7 lg:py-0'
        }`}
      >
          ...
          <div className='flex w-full items-center justify-between lg:w-1/4'>
            <Link href='/' className='flex items-center gap-2'>
              <Image
                ...
                height={48}
              />
              <span className='text-xl font-bold text-white'>Jven Butatil</span>
            </Link>
