          ...
          <div className='flex flex-wrap justify-between'>
            <div className='mb-10 w-full max-w-[520px]'>
              ...
              <p className='mb-12 xl:w-4/5'>
                Full-stack developer specializing in web technologies with
                certified expertise in HTML, Java, and MySQL. Building
                innovative solutions and turning ideas into reality.
              </p>

              <p className='mt-5.5 font-medium'>
                Jven Butatil. All rights reserved.
              </p>
            </div>

            <div id='social' className='mb-10 flex flex-col items-start gap-8'>
              ...
              <div className='flex items-center gap-5'>
                ...
                <a
                  href='https://github.com/jvenkrause02-afk'
                  target='_blank'
